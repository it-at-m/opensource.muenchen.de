...
The remedy can be to only use PaaS services that are based on an open-source project. A Database as a Service (DBaaS) based on PostgreSQL, for example, is less susceptible to hard vendor lock-in than proprietary solutions <small>(Source: Sujeevan Vijayakumaran, DevOps, ISBN 978-3-8362-9099-9, page 264)</small>.
