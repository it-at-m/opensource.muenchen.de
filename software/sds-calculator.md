...
The sds-calculator repository is a small, static web application for calculating the Digital Sovereignty Score (SDS) based on a short checklist with yes/no answers.
