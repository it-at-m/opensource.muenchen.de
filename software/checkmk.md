...
To enable direct monitoring of various database systems over network connections, we have funded the [Database Special Agent](https://github.com/automation-monitoring/agent_db).
